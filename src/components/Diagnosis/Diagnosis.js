...
function Diagnosis() {
  ...
  const validationSchema = yup.object({
    numberOfDiagnosis: yup.string().required("Number of diagnosis is required"),
                      ...
                      <Field name="numberOfDiagnosis">
                        {({ field }) => (
                          <select
                            ...
                            as={Form.Control}
                            onChange={(e) =>
                              onChangeDiagnosis(e, field, values, setValues)
                            }
                          >
                            <option value=""></option>
                  ...
                  <FieldArray name="symptoms">
                    {() =>
                      values.symptoms.map((symptom, i) => {
                        ...
                        const ticketTouched = touched.symptoms?.length && touched.symptoms[i] || {};
                        return (
