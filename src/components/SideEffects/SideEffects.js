                        ...
                        <Container className="flex-row justify-content-center">
                          <Table responsive="sm" hover>
                            <thead className="thead-light">
                              <tr>
                                <th colspan="4">Symptoms & Side Effects</th>
                                <th>Frequency</th>
                                <th>Notable Patterns</th>
                              </tr>
                            </thead>
                            <tbody>
                              {values.sideEffects.map((sideEffect, i) => (
                                <tr key={i}>
                                  <td colspan="1">
                                    <Button
                                      variant="secondary"
                                  ...
                                  <td>
                                    <SelectField
                                      ...
                                      value={values.sideEffects[i].frequency}
                                      onChange={setFieldValue}
                                      promiseOptions={promiseOptions2}
                                    />
                                  </td>
                                  <td>
                                    <SelectField
                                      name={`sideEffects.${i}.patterns`}
                                      value={values.sideEffects[i].patterns}
                                      onChange={setFieldValue}
                                      promiseOptions={promiseOptions3}
                                    />
                                  </td>
                                </tr>
                              ))}
